        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 md:h-screen mx-auto lg:py-0">
            ...
            <div class="relative z-10 w-full bg-white rounded-lg shadow dark:border sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('register_tutor.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:text-white" placeholder="081234567890" required>
                        </div>

                        <div>
                            <label for="portfolio" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Portofolio</label>
                            <input type="file" name="portfolio" id="portfolio" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:text-white" required>
                        </div>
