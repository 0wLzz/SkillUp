            ...
            <div class="rounded-lg mx-auto container">
                ...
                <div class="grid grid-cols-4 gap-6">
                    ...
                    @forelse ($ownedCourse as $course)
                        <div
                            class="bg-gray-700 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow relative">
                            ...
                            <form id="delete" onsubmit="" action="{{ route('courses.destroy', $course) }}"
                                method="POST" class="absolute top-2 right-2">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                                    class="bg-red-500 hover:bg-red-600 text-white p-2 rounded-full shadow-md transition-colors">
