<x-admin_layout>
    ...
    <div class="max-w-screen-xl mx-auto p-4 bg-white rounded-xl mt-4 space-y-4">
        ...
        @forelse ($courses as $course)
            <div class="grid grid-cols-6 gap-4 items-center p-4 border rounded shadow-sm">
                <img src="{{ asset('storage/' . $course->thumbnail) }}" alt="Thumbnail" class="w-24 h-24 object-cover rounded">
                ...
                <div class="flex gap-2">
                    ...
                    <form action="{{ route('courses.destroy', $course->id) }}" method="POST" onsubmit="return confirm('Yakin mau hapus kursus ini?')">
                        @csrf
                        @method('DELETE')
                        <button type="submit" 
