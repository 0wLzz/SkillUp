    ...
    <section class="bg-white dark:bg-gray-900 h-min-screen items-center pb-8">
        <div class="max-w-screen-xl mx-auto">
            <div class="grid grid-cols-2">
                <div
                    class="mx-auto max-w-sm my-24 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    {{-- Card --}}
                    <a href="#">
                        <img class="rounded-t-lg" src="{{ asset('assets/AboutUs.png') }}" alt="" />
                    </a>
                    <div class="p-5 text-white">
                        <p class="">Benefit Kelas</p>
                        <ol class="mb-3">
                            <li>1. Materi Leadership</li>
                            <li>2. Materi Leadership</li>
                            <li>3. Materi Leadership</li>
                            <li>4. Materi Leadership</li>
                        </ol>
                        ...
                        <div class=" grid grid-cols-4 place-items-center">
                            ...
                            <p class="font-normal text-gray-700 dark:text-white">100</p>
                            <p class="font-normal text-gray-700 dark:text-white">100</p>
                            <p class="font-normal text-gray-700 dark:text-white">Chat</p>
                        </div>
                    </div>
                    <div class="border-t-2 p-8">
                        <p class="text-white">Rp. 500.000</p>
                        <a href="{{ route('course_payment') }}"
                            class="p-2.5 w-full text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 block">
                ...
                <div class="text-white my-24 flex flex-col gap-2">
                    <h1 class="text-4xl">Belajar Membangun Koneksi dengan orang yang belum dikenal</h1>
                    <p class="text-gray-400">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab nobis, velit
                        omnis doloremque animi repellat a sunt quis natus eius placeat dolorem voluptate quia sint
                        consequatur? Quas illo beatae distinctio Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Omnis accusamus laborum atque illum numquam, dignissimos beatae minima unde voluptate
                        eaque cum delectus at, voluptates sunt, earum perferendis sed nam eum!
                    </p>
                    ...
                    <p class="text-gray-400">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab nobis, velit
                        ...
                        consequatur? Quas illo beatae distinctio Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Omnis accusamus laborum atque illum numquam, dignissimos beatae minima unde voluptate
                        eaque cum delectus at, voluptates sunt, earum perferendis sed nam eum! Lorem ipsum, dolor sit
                        amet consectetur adipisicing elit. Corporis eveniet, similique autem laboriosam ratione expedita
                        nesciunt unde id ut hic odit! Hic excepturi ex ducimus officiis at, similique magni reiciendis.
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magni repellat culpa quam quidem
                        ducimus facere similique omnis. Quo quas, eius ullam a est officiis, numquam pariatur quod non
                        illo saepe.
                    </p>
                </div>
            </div>
            ...
            <div class="text-white mb-8">
                <h2 class="text-3xl font-bold mb-4">Tutor</h2>
                <div class="flex items-center mb-4">
                    <img class="w-50 h-50 rounded-full aspect-square object-cover"
                        src="{{ asset('assets/Carousel2.jpg') }}" alt="Rounded avatar">
                    <div class="flex flex-col ml-4 text-2xl">
                        <p class="font-bold"> Ambda Jansen </p>
                        <p class="text-blue-400"> Communication Expert </p>
                    </div>
                </div>
                <p class="text-gray-400 text-xl">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laudantium aut officia, modi odit minima
                    iusto eos incidunt ad amet ullam optio accusantium voluptatibus expedita ducimus necessitatibus
                    voluptates quas esse iure. Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis et autem
                    debitis laboriosam magnam totam ducimus corrupti nisi eos. Dolor obcaecati necessitatibus alias
                    facilis iusto illum a assumenda tempora eum?
                </p>
            </div>

            {{-- Materi  --}}
            <div class="flex justify-center text-white bg-gray-700">
            ...
            <div id="category-carousel"
                class="items-center relative w-full text-center bg-gray-800 rounded drop-shadow-xl text-gray-500 mb-6 sm:text-lg dark:text-gray-400">
                <!-- Category Display -->
            ...
            <div class="grid grid-cols-4 gap-8 gap-y-10 mb-8">
                <x-card.course />
                <x-card.course />
                <x-card.course />
                <x-card.course />
